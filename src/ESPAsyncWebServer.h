...
#ifndef WEBSERVER_H
typedef enum {
  HTTP_GET2     = 0b00000001,
  HTTP_POST2    = 0b00000010,
  HTTP_DELETE2  = 0b00000100,
  HTTP_PUT2     = 0b00001000,
  HTTP_PATCH2   = 0b00010000,
  HTTP_HEAD2    = 0b00100000,
  HTTP_OPTIONS2 = 0b01000000,
  HTTP_ANY     = 0b01111111,
} WebRequestMethod;
#endif
