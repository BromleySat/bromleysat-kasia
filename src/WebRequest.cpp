...
/*
    Attribution:
        This file was originally coppied from https://github.com/me-no-dev/ESPAsyncWebServer
        It may have been modified since then, please refer to the source to see the original
*/
...
const char * AsyncWebServerRequest::methodToString() const {
  ...
  else if(_method & HTTP_GET2) return "GET";
  else if(_method & HTTP_POST2) return "POST";
  else if(_method & HTTP_DELETE2) return "DELETE";
  else if(_method & HTTP_PUT2) return "PUT";
  else if(_method & HTTP_PATCH2) return "PATCH";
  else if(_method & HTTP_HEAD2) return "HEAD";
  else if(_method & HTTP_OPTIONS2) return "OPTIONS";
  return "UNKNOWN";
}
